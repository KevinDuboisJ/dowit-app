...
{
    // Pure enums don’t support from or tryFrom as those methods gets the enum case by the backed value. (This doesn't work: DaysOfWeek::tryFrom('monday')
    // because DaysOfWeek has no backed values) there’s no built-in PHP function to get enum case by its name dynamically
