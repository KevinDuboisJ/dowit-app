...
const Autocomplete = ({ onValueChange = null }) => {
  ...
  if (loading) {
    return (
      <Badge className="flex items-center justify-between text-xs text-slate-500 font-normal h-8 bg-white" variant="outline">
        <Loader />
        <Heroicon
          icon="XMark"
