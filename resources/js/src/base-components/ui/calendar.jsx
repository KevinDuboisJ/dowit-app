  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "!bg-slate-900 !text-slate-50 hover:!bg-slate-900 hover:!text-slate-50 dark:!bg-slate-50 dark:!text-slate-900 dark:hover:!bg-slate-50 dark:hover:!text-slate-900",
